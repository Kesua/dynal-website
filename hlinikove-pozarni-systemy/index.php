               ...
               <div class="box-product-3-bg">
                  <div class="box-product">
                     <div class="boxproduct--picture">
						 <img src="../images/produkty/hlinikova-okna-dvere/pozarni-systemy/fr-90.png" width="100%" height="auto" alt="Požární systém FR 90" title="Požární systém FR 90"></div>
                     <h2><a class="boxproduct--odkaz" href="/hlinikove-pozarni-systemy/fr-90">Požární systém <br />FR 90</a></h2>
                  </div> 
               </div>
            </div>
         </div>
