...
<head>
   ...
   <title>Hliníkové požární systémy | Dynal</title>
...
<body>
   ...
   <div id="page">
      <div class="wrapper">
         <div class="odraz-20">
            <div id="page-nazev"><h1>Hliníkové požární systémy</h1></div>
               
            <div id="box-product-panel">
               <div class="box-product-3-bg">
                  <div class="box-product">
                     <div class="boxproduct--picture">
						 <img src="../../images/produkty/hlinikova-okna-dvere/posuvne-systemy/ultraglide.png" width="100%" height="auto" alt="Požární systém FR 90" title="Požární systém FR 90"></div>
                     <h2><a class="boxproduct--odkaz" href="/hlinikova-okna-a-dvere/serie-star">Požární systém <br />FR 90</a></h2>
                  </div> 
               </div>
            </div>
         </div>
